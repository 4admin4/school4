...
RESPONSES = {
    "Старт": (
        "Почнемо з простого🥳. Обери надійний пароль з наявних та введи його.\n\n"
        " pas123;  Nastya12;  N43i@_2nisU "
    ),
    "!N43i@_2nisU": "Молодець🤩, ти переміг! Забери подарунок: https://viktorina.webnode.com.ua/",
    "123w": (
        "⚠️ Не переходь на невідомі посилання та не завантажуй підозрілі файли! "
    ...
    "фішинг": (
        "Супер🏅. Для того щоб уникнути фішингу🎣:\n"
    ...
    "Школа": (
        "Гімназія №4 Павлоградської міської ради.\n"
        "📍 Адреса:\n"
