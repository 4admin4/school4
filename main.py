...
async def send_schedule(message: types.Message):
    ...
    if photo_id:
        ...
        await message.answer("❌ Розклад поки не завантажений. Адмін має використати /set_schedule")
...
async def school_menu(message: types.Message):
    ...
    if photo_id:
        ...
        await message.answer("🍴 Меню ще не завантажене. Адмін має використати /set_menu")
...
async def school_info(message: types.Message):
    text = (
        ...
        "📍 <b>Адреса:</b> вул. Корольова Сергія, буд. 3, м. Павлоград\n"
...
async def main():
    ...
    # Запуск бота та сервера паралельно
